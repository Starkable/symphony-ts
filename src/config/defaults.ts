...
export const DEFAULT_CLAUDE_MODEL = null;
export const DEFAULT_CLAUDE_PERMISSION_MODE = "acceptEdits" as const;
export const DEFAULT_CLAUDE_REUSE_POLICY = "per_issue" as const;
export const DEFAULT_CLAUDE_TURN_TIMEOUT_MS = 3_600_000;
...
export const DEFAULT_ARTIFACT_STORE_ENABLED = false;
export const DEFAULT_ARTIFACT_STORE_HYDRATE = false;
...
export const SPEC_DEFAULTS = Object.freeze({
  ...
  artifactStore: {
    enabled: DEFAULT_ARTIFACT_STORE_ENABLED,
    hydrateOnCreate: DEFAULT_ARTIFACT_STORE_HYDRATE,
  },
} as const);
